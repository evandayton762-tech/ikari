 ...
 * Reference for the GraphQL types: https://shopify.dev/docs/api/storefront/2025-04/scalars/HTML
...
/**
 * Meant to be used with GraphQL CodeGen to type the Storefront API's custom scalars correctly.
 * Reference for the GraphQL types: https://shopify.dev/docs/api/customer/2025-04/scalars/HTML
 * Note: JSON is generated as 'unknown' by default.
 */

...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-KC5QI22K.js"), { isDevelopment } = await import("./local-BE7LTPTW.js"), oclif = await import("./lib-MWWAATIC.js"), { ShopifyConfig } = await import("./custom-oclif-loader-SNCTJFAW.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-UWCAHSHB.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-URP7ZOL6.js"), { moduleDirectory } = await import("./path-2K5HIMHZ.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-Y4DB5LTR.js.map
